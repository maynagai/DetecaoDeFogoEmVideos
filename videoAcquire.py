...
for x in range(1,30):
    ...
    if x!=24:
        camera = cv2.VideoCapture(folder+file+str(x)+".avi")
        videoFile = file+str(x)
        ...
        while True:
            ...
            fgmask2 = cv2.dilate(fgmask2, None, iterations=3)
            ...
            cv2.imwrite(folder1+videoFile+"_frame%d.jpg" % contFrames, diffImg)
